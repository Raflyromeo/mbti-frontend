  ...
  return (
    ...
    >
      ...
      <div className={`hidden lg:flex p-4 items-center ${dilipat ? "justify-center" : "justify-between"} h-16 border-b-4 border-[var(--border)] bg-[var(--kedua)] shrink-0`}>
        {dilipat ? (
          <div className="w-10 h-10 bg-[var(--utama)] text-[var(--utama-foreground)] font-black text-xl flex items-center justify-center border-4 border-black rounded-lg shadow-[2px_2px_0px_0px_rgba(0,0,0,1)]">
            M
          </div>
        ) : (
